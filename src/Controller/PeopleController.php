...
class PeopleController extends AppController
{
    ...
    public function add()
    {
        ...
        $institutions = $this->People->Institutions->find('list', ['limit' => 200]);
        $meetings = $this->People->Meetings->find('list', ['limit' => 200]);
        $this->set(compact('person', 'institutions', 'meetings'));
    }
